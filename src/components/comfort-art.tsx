...
const COMFORT_SCENE_META: Record<string, { sky: string; ground: string; accent: string }> = {
  ...
  // ---- 扩充 1.2 ----
  cm_noodles: { sky: '#f6e6c8', ground: '#e2c49a', accent: '#c07840' },
  cm_ledger: { sky: '#f2e4c6', ground: '#d8c090', accent: '#a87a4a' },
  cm_running: { sky: '#f5dcc0', ground: '#c8b498', accent: '#e08a50' },
  cm_haircut: { sky: '#eee8e0', ground: '#cfc4b2', accent: '#8a7a68' },
  cm_bus: { sky: '#dfe4ec', ground: '#a8b2c2', accent: '#4a6a9a' },
  cm_rain: { sky: '#dde4ea', ground: '#b0bcc8', accent: '#5a7a8a' },
  cm_desk: { sky: '#f4e2c4', ground: '#d8bc8e', accent: '#b07848' },
  cm_market: { sky: '#f6e8cc', ground: '#dcc494', accent: '#c07848' },
  cm_match: { sky: '#e8e2d8', ground: '#c4b8a4', accent: '#8a7058' },
  cm_tomato: { sky: '#f4deba', ground: '#d8b088', accent: '#c05a3a' },
  cm_sweater: { sky: '#f4dcc4', ground: '#d8a888', accent: '#a85848' },
  cm_moon: { sky: '#d8dce8', ground: '#98a2b8', accent: '#e8c878' },
  cm_train: { sky: '#e4e0d0', ground: '#b0b090', accent: '#5a7a5a' },
  cm_pill: { sky: '#f2e8dc', ground: '#d8c8b0', accent: '#a88878' },
  cm_pot: { sky: '#f6e4c2', ground: '#dcbc8c', accent: '#c08848' },
  cm_umbrella: { sky: '#d8dee6', ground: '#a8b4c0', accent: '#4a6a8a' },
  cm_arcade: { sky: '#e4d8ec', ground: '#b898c0', accent: '#c05a8a' },
  cm_night_walk: { sky: '#dcdce8', ground: '#a8a8bc', accent: '#c0a060' },
  cm_gift: { sky: '#f6e8cc', ground: '#dcc490', accent: '#b07838' },
  cm_back: { sky: '#d8dee8', ground: '#a0aebc', accent: '#3a5a8a' },
  cm_picnic: { sky: '#f2e8c8', ground: '#c8c088', accent: '#6a8a5a' },
  cm_karaoke: { sky: '#ecd8e8', ground: '#c0a0c0', accent: '#b05a9a' },
  bm_car: { sky: '#f4dcd0', ground: '#d8a898', accent: '#c04848' },
  bm_hotel: { sky: '#d8e8ec', ground: '#98c0cc', accent: '#e8a878' },
  bm_shoes: { sky: '#f4e4d0', ground: '#d8bc94', accent: '#b8805a' },
  bm_dinner: { sky: '#f0dcc8', ground: '#c89878', accent: '#a04838' },
  bm_flight: { sky: '#e0e8ee', ground: '#b4c2cc', accent: '#6a8aa0' },
  bm_flower: { sky: '#f6e4d4', ground: '#dcc09c', accent: '#c890a0' },
};
