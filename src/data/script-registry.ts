...
export const SCRIPTS: Record<string, TargetScript> = {
  lao_li: { chain: LAO_LI_CHAIN, free: LAO_LI_FREE, lines: LAO_LI_LINES, packs: LAO_LI_PACKS, incoming: INCOMING_LINES.lao_li },
  zhou_teacher: { chain: ZHOU_CHAIN, free: ZHOU_FREE, lines: ZHOU_LINES, packs: ZHOU_PACKS, incoming: INCOMING_LINES.zhou_teacher },
  boss_wang: { chain: WANG_CHAIN, free: WANG_FREE, lines: WANG_LINES, packs: WANG_PACKS, incoming: INCOMING_LINES.boss_wang },
  hao_ge: { chain: HAO_CHAIN, free: HAO_FREE, lines: HAO_LINES, packs: HAO_PACKS, incoming: INCOMING_LINES.hao_ge },
  chen_gong: { chain: CHEN_CHAIN, free: CHEN_FREE, lines: CHEN_LINES, packs: CHEN_PACKS, incoming: INCOMING_LINES.chen_gong },
};

/** 库目标（45 人）没有专属脚本——按原型挂 ARCHETYPE_PACKS + 通用台词。 */
import { ARCHETYPE_PACKS } from './archetype-packs';
