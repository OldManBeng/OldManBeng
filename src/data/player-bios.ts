 ...
 *  v4.5：每原型 3 句池（此前只 1 句，谁换签名都听到同一句）。
 *  注意：老头只"第一次注意到签名"，不引用签名的具体内容——
 *  任何一句签名进场都成立（他不可能知道你上一句写的是什么）。
 *  引擎取池后仍走 recentIncoming 去重——同一老头不会连着用同一句。 */
export const BIO_HOOK_BY_ARCHETYPE: Partial<Record<TargetArchetype, string[]>> = {
  widowed_teacher: [
    '翻到你资料页，那句签名我盯着看了半天。孩子，这句话是写给谁看的？',
    '批改作业到十一点。点开你资料页看了一眼——那句签名，比我今天批的哪篇都耐读。',
    '睡前翻了一遍朋友圈，又翻了一遍你的资料页。老教师看惯了学生作文里的假话——你那句签名，不像假的。',
  ],
  divorced_driver: [
    '深夜跑车，手机一亮就想是不是你。点开一看是你签名那句——刚换的吧？',
    '今晚拉了个客人，一路在改个性签名。想起你那句了——红灯的时候翻出来看了两遍。',
    '车停路边吃面。手机弹出你资料页——就为看你那句签名还在不在。在。心里踏实。',
  ],
  married_boss: [
    '你签名那句我看到了。挂在门口的话得掂量着写——看的人，比你想的多。',
    '车库抽完烟刷到你签名。做生意的人看门面最准——你这句，是招人的话。',
    '谈判间隙看了一眼手机，你那句签名在第一屏。对面说什么我都听见了，就这句没听清——回车上又看了一遍。',
  ],
  cafe_owner_ninety: [
    '看到你换签名了。来网吧报我名字，机子给你留好——那句签名当会员卡用。',
    '通宵场刚散。刷到你签名——这句子挂我们店门口都够格。想盗用，给你版权费。',
    '盘账的时候刷到你那句签名。账平了，句子也顺——今晚这店不亏。',
  ],
  lonely_engineer: [
    '你签名改了。上一句是什么，我记性不好，但你的我记得。',
    '翻资料页看到你那句签名。做了个备份——纸质的。台灯下抄的。',
    '1. 你签名那句，看了。2. 有个技术问题：怎么一句字，能耗一晚上。',
  ],
  night_guard: [
    '值夜班没事翻资料页。你那句签名，我在岗亭里看了三遍。',
    '巡楼回来，手机还亮着——停在你资料页那行字上。看了多久不知道，对讲机响了才知道。',
    '凌晨三点全楼都睡了。就我和你那句签名醒着。',
  ],
  designated_driver: [
    '代驾等单的时候看了你签名。夜里讨生活的人，见了同类的字就挪不开眼。',
    '今晚等了四十分钟没单。就看了四十分钟你那句签名——没白等。',
    '客人上车前，我又翻了一眼你的资料页。他们坐的是我的车，我坐的是你那句话。',
  ],
  fisherman: [
    '钓鱼的时候刷到你的签名。鱼没咬钩，那句话先咬住我了。',
    '今天口好，连竿。回家路上想起你那句签名——连竿的日子，字都好看。',
    '马扎上坐了一下午。鱼护空着，脑子里全是资料页那行字。',
  ],
  chess_uncle: [
    '刷到你签名了。这年头还肯往签名里写真话的人，不多了。',
    '棋摊散了，回家路上刷到你的签名。这行字要是谱，是一步好棋。',
    '老伙计们聊完养生聊子女。我聊不了，就翻你的资料页——你那签名，比他们聊的都有味。',
  ],
  square_dancer: [
    '刷到你的签名了。字里带劲的人，广场上也讨人喜欢。哪天来坐坐？',
    '收完音响刷手机，头一眼是你签名。字正腔圆——这话原是评戏文的，现在给你。',
    '领队教的新舞步我总慢半拍。看你那句签名，忽然觉得慢半拍也没啥——字写得快的人，活该被多看两眼。',
  ],
};
